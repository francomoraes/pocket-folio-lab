export default {
  upload: {
    title: "Importar Posições via CSV",
    description: "Faça upload de um arquivo CSV para importar suas posições",
    ...
    invalidFile: "Por favor, selecione um arquivo CSV válido.",
    maxSize: "O arquivo CSV deve ter no máximo 5MB.",
